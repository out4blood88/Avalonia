...
namespace Avalonia.Base.UnitTests.Rendering.SceneGraph
{
    public class VisualNodeTests
    {
        ...
        {
            var node1 = new VisualNode(Mock.Of<Visual>(), null);
            var node2 = new VisualNode(Mock.Of<Visual>(), null);
        ...
        {
            var node = new VisualNode(Mock.Of<Visual>(), null);
            var collection = node.Children;

            node.AddChild(Mock.Of<VisualNode>(x => x.Parent == node));
        ...
        {
            var node = new VisualNode(Mock.Of<Visual>(), null);
            var scene = new Scene(Mock.Of<Visual>());
